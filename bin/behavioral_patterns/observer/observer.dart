...
class JavaDeveloper implements Subscriber{
  String name;
  Set<String> v = {};

  JavaDeveloper(this.name);

  @override
  void changeNotify(List<String> vacancy) {
    for(int i=0;i<vacancy.length;i++){
      if(vacancy[i].contains("Java")){
        v.add(vacancy[i]);
      }
    }
...
class FlutterDeveloper implements Subscriber{
  String name;
  Set<String> v = {};
